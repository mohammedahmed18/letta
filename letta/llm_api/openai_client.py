...
def accepts_developer_role(model: str) -> bool:
    ...
    """
    # Rewritten for speed and logic clarity
    # True if (is reasoning model AND not 'o1-mini' in model) OR 'o1-preview' in model
    if (model.startswith(("o1", "o3", "o4")) and "o1-mini" not in model) or "o1-preview" in model:
        return True
    else:
        return False
